...
![Tests](https://img.shields.io/badge/tests-438%20passing-brightgreen.svg)
...
| **Test suite** | **438 passing**, incl. 58 solver-numerics, 27 MOS-cap physics and 41 ohmic-gradient tests | `make test` |
...
```bash
make test                          # 438 tests, ~1 min 5 s (n=3, 61-65 s)
