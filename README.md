...
![Tests](https://img.shields.io/badge/tests-509%20passing-brightgreen.svg)
...
| **Test suite** | **509 passing**, incl. 58 solver-numerics, 27 MOS-cap physics and 41 ohmic-gradient tests | `make test` |
...
```bash
make test                          # 509 tests, ~2 min 55 s (n=3, 171-181 s)
