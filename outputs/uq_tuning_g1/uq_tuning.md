...
|---|---:|---:|---:|---:|---:|---:|---:|
| `deep_ensemble` | 2.64% | +0.798 | -1.452 | 0.1324 | 21.3x | 12.1x | 46.6 |
| `mc_dropout_tuned` | 5.91% | +0.299 | 18.737 | 0.1631 | 1.4x | 12.4x | 16.2 |
| `swag_tuned` | 2.90% | +0.486 | 1.814 | 0.1269 | 2.5x | 13.2x | 10.2 |

Selected: MC-dropout `{'dropout_p': 0.01, 'train_seconds': 16.188299655914307, 'n_networks': 1, 'params': 35457, 'forward_passes_per_prediction': 30}`, SWAG `{'swa_lr': 0.0005, 'scale': 0.25, 'train_seconds': 10.174274682998657, 'n_networks': 1, 'params': 35457, 'forward_passes_per_prediction': 30, 'snapshots': 20}`.
